...
export default class Product {
    ...
    static #columns = ['id', 'nome', 'codigo_barra', 'unidade', 'preco_compra', 'preco_venda', 'ativo', 'created_at', 'updated_at', null];
    ...
    static async insert(data) {
        ...
        try {
            ...
            return { status: true, msg: 'Produto salvo!', id: result.id, data: [result] };
        } catch (err) {
