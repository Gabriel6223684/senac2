...
export default class Enterprise {
    ...
    static #columns = ['id', 'nome', 'cnpj', 'email', 'criado_em', 'atualizado_em', null];
    ...
    static async findById(id) {
        ...
        try {
            ...
            console.error('Erro ao buscar enterprise por ID:', err);
            return null;
        }
    }
    ...
    static async insert(data) {
        ...
        try {
            ...
            console.error('Erro ao inserir enterprise:', err);
    ...
    static async update(id, data) {
        ...
        try {
            ...
            if (!result) {
                return { status: false, msg: 'Enterprise não encontrada', data: [] };
            }

            return { status: true, msg: 'Atualizado com sucesso!', id: result.id, data: [result] };
        } catch (err) {
            console.error('Erro ao atualizar enterprise:', err);
    ...
    static async delete(id) {
        ...
        try {
            ...
            console.error('Erro ao remover enterprise:', err);
